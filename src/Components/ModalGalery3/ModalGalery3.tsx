...
export default function ModalGalery3() {
  ...
  const {URLPutGallery3}= useContext(AppContext); 
    ...
    try {
      ...
      if (data.message.includes("Ok")) {
        onClose() 
          toast({
            title: "Sucesso",
            description: "galeria 3 criada com sucesso!",
            status: "success",
            duration: 6000,
            isClosable: true,
            position: "bottom-left",
