...
export default function ModalGalery2() {
  ...
  const {URLPutGallery2}= useContext(AppContext); 
    ...
    try {
      ...
      if (data.message.includes("Ok")) {
        onClose() 
          toast({
            title: "Sucesso",
            description: "galeria 2 criada com sucesso!",
            status: "success",
            duration: 6000,
            isClosable: true,
            position: "bottom-left",
